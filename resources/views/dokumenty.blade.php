                    ...
                    <div class="col-sm-12 lista p-0">
                        @foreach($docs as $doc)
                            <div class="row d-flex align-items-center p-2">
                                <h5 class="m-0 col-sm-8">{{ $doc->name }}</h5>
                    ...
                    @if($regulaminy->count())
                        ...
                        <div class="col-sm-12 lista p-0">
                            @foreach($regulaminy as $regulamin)
                                <div class="row d-flex align-items-center p-2">
                                    <h5 class="m-0 col-sm-8">{{ $regulamin->name }} @if($regulamin->sub_name) - {{ $regulamin->sub_name }}@endif<br><small>{{ $regulamin->race->name }}</small></h5>
                                    <div class="col-sm-4 text-right">
                        ...
                        <div class="col-sm-12 lista p-0">
                            @foreach($forms as $form)
                                <div class="row d-flex justify-content-between align-items-center p-2">
                                    <h5 class="m-0 col-6">{{ $form->round->name }} @if($form->round->sub_name) - {{ $form->round->sub_name }}@endif<br><small>{{ $form->round->race->name }}</small></h5>
