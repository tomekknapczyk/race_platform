<div class="modal fade" tabindex="-1" role="dialog" id="editSignUser" aria-labelledby="editSignUser" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('editSignUser') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="form_id" id="edit_form_id">
                    <h3 class="text-center my-3">Dane pilota</h3>
                    <div id="edit_pilot_uid_container">
                        <div class="row justify-content-center align-items-center">
                            <div class="text-center">
                                <div class="d-flex justify-content-center align-items-end">
                                    <div>
                                        <select class="form-control" id="edit_sign_pilot">
                                    ...
                                    <div>
                                        <label for="name" class="text-left d-block">Wpisz id pilota</label>
                                        <input type="text" name="pilot_uid" id="edit_sign_pilot_uid" class="form-control">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="saved" id="edit_saved" class="form-control">
                                    ...
                                    @endif
                                    <button class="btn btn-info ml-4" id="edit_getPilotUid">Pobierz dane</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="edit_pilot_name" class="form-control" required="" readonly=""> 
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="lastname" id="edit_pilot_lastname" class="form-control" required="" readonly=""> 
                        ...
                        <div class="col-6 form-group">
                            ...
                            <textarea name="address" class="form-control" id="edit_pilot_address" rows="4" readonly=""></textarea>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="edit_pilot_phone" class="form-control" readonly=""> 
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="edit_pilot_email" class="form-control" readonly=""> 
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="id_card" id="edit_pilot_id_card" class="form-control" readonly=""> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="driving_license" id="edit_pilot_driving_license" class="form-control" readonly=""> 
                    ...
                    <div class="row justify-content-center align-items-center mt-4">
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div class="ml-4">
                                <select class="form-control" id="edit_sign_car" required="">
                    ...
                    <div class="row mt-4">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="marka" id="edit_car_marka" class="form-control" required="" readonly=""> 
                                @if ($errors->has('marka'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-3"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="model" id="edit_car_model" class="form-control" required="" readonly=""> 
                                @if ($errors->has('model'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nr_rej" id="edit_car_nr_rej" class="form-control" required="" readonly=""> 
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rok" id="edit_car_rok" class="form-control" required="" readonly=""> 
                                @if ($errors->has('rok'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="ccm" id="edit_car_ccm" class="form-control" required="" readonly=""> 
                                @if ($errors->has('ccm'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="oc">Nazwa nr polisy OC</label>
                                <input type="text" name="oc" id="edit_car_oc" class="form-control" required="" readonly=""> 
                                @if ($errors->has('oc'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('oc') }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="nw">Nazwa nr polisy NW</label>
                                <input type="text" name="nw" id="edit_car_nw" class="form-control" readonly=""> 
                                @if ($errors->has('nw'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('nw') }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input car_turbo" type="checkbox" id="edit_turbo" disabled="">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input car_rwd" type="checkbox" id="edit_rwd" disabled="">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="klasa" class="form-control" id="edit_sign_klasa" required="">
