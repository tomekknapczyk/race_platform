    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-dark">
                <div class="card-header bg-yellow">{{ __('Register') }}</div>
...
{{--                                 <div class="form-check form-check-inline">
                        ...
                        <div class="form-group row">
                            <label for="email-confirm" class="col-md-4 col-form-label text-md-right">Powtórz adres e-mail</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small id="passwordHelp" class="form-text text-muted">Min. 6 znaków</small>
